...
$sql = $koneksi->query("select * from tb_obat where id_obat = '$id_obat'");
 ...
 <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form method="POST" action="?page=view_obat&aksi=simpan_ubah">
                                        <div class="form-group">
                                           
                                          	<input class="form-control" type="hidden" name="id_obat" value="<?php echo $tampil['id_obat']?>" readonly/>
                                        </div>
